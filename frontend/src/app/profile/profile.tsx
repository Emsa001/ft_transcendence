...
export const ProfileCard = () => {
    ...
    return (
        <div className="flex flex-col justify-evenly h-full w-full p-10 text-white">
            <div className="flex flex-row">
                <div className="flex flex-col md:flex-row items-start gap-6 flex-9">
                    <UserPicture />
                    {!edit ? (
                ...
                <button
                    className="w-[10px] h-[40px] flex-1 text-white p-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors z-10 "
            ...
            {/* Logout */}
            <div className="flex items-center flex-row justify-">
                <LogoutButton />
                <DeleteButton />
            </div>
        </div>
