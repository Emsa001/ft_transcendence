...
export default function Friends() {
    ...
    useEffect(() => {
        const fetchFriends = async () => {
            try {
                const allFriends = await friendsApi.getAllUsers();
    ...
    return (
        <div>
            <div className="text-center mb-8">
                ...
                <p className="text-gray-400">You have {friends.length} friends</p>
            </div>
                    ...
                    <div key={friend.id} className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-white-800">{friend.username}</h3>
                                </div>
                            </div>
