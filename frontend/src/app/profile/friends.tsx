...
export default function Friends() {
    ...
    // fake friends data
    const fakeFriends = [
        { id: 12, name: "Emanuella Scura", avatar: "https://via.placeholder.com/50" },
        { id: 4, name: "Tobias Riedel", avatar: "https://via.placeholder.com/50" },
        { id: 5, name: "Bequ Beqa", avatar: "https://via.placeholder.com/50" },
        { id: 7, name: "Emma Watson", avatar: "https://via.placeholder.com/50" },
        { id: 2, name: "Paulo Beckhausa", avatar: "https://via.placeholder.com/50" },
    ];
                    ...
                    <div key={friend.id} className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-white-800">{friend.name}</h3>
                                </div>
                            </div>
